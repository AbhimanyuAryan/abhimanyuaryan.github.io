...
- [Flappy Birds project on GitHub](https://github.com/ivdstudios/Flappy-Birds)

{% include figure.liquid path="/assets/img/news/womenwhocode.jpg" class="img-fluid rounded z-depth-1" max-width="520px" %}
