...
Live at [pkgs.genieframework.com](https://pkgs.genieframework.com/).

### Tech Stack

- **Julia** (Genie.jl, Stipple.jl, StippleUI.jl, StipplePlotly.jl)
- **JavaScript**
- **PostgreSQL / SQLite**
- **Docker** (Fly.io deployment)
- **Swagger/OpenAPI** (via SwagUI.jl)

### Links

- [GitHub Repository](https://github.com/GenieFramework/PkgVizBoard)
- [Live App](https://pkgs.genieframework.com/)
